...
declare namespace Cypress {
    interface Chainable {
        ...
        /**
         * Return static JSON files defined in the fixtures directory when an API call is made to a '/v2/groups/*'
         * endpoint.
         * @example mockGroupAPI()
         */
        mockGroupAPI(): void;

        /**
         * Return static JSON files defined in the fixtures directory when an API call is made to a
         * '/v2/groups/leaderboard/*' endpoint.
         * @example mockGroupLeaderboardAPI()
         */
        mockGroupLeaderboardAPI(): void;

        /**
         * Return static JSON files defined in the fixtures directory when an API call is made to a
         * '/v2/groups/members/*' endpoint.
         * @example mockGroupMembersAPI()
         */
        mockGroupMembersAPI(): void;

        /**
         * Return static JSON files defined in the fixtures directory when an API call is made to a
         * '/v2/groups/statistics/*' endpoint.
         * @example mockGroupStatisticsAPI()
         */
        mockGroupStatisticsAPI(): void;

        /**
         * Return static JSON files defined in the fixtures directory when an API call is made to a '/v2/groups/team/*'
         * endpoint.
         * @example mockGroupTeamAPI()
         */
        mockGroupTeamAPI(): void;
         ...
         * '/email/activation-code' endpoint.
         * @example mockActivationCodeEmailFnAPI()
         */
        mockActivationCodeEmailFnAPI(): void;
        ...
        /**
         * Return static JSON files defined in the fixtures directory when a Function API call is made to a
         * '/uasset/group' endpoint.
         * @example mockUassetGroupFnAPI()
         */
        mockUassetGroupFnAPI(): void;
    }
}