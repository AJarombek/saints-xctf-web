...
function getGroupMembershipsRequestReducer(state: MembershipsState,
                                           action: GetGroupMembershipsRequestAction): MembershipsState {
    return {
        ...state,
        groups: {
            isFetching: true,
...
function getGroupMembershipsSuccessReducer(state: MembershipsState,
                                           action: GetGroupMembershipsSuccessAction): MembershipsState {
    return {
        ...state,
        groups: {
            isFetching: true,
...
function getGroupMembershipsFailureReducer(state: MembershipsState,
                                           action: GetGroupMembershipsFailureAction): MembershipsState {
    return {
        ...state,
        groups: {
            isFetching: true,
